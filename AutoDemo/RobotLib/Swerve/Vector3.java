...
public final class Vector3 {
    ...
    /**
     * Creates a new vector from a float array containing the x, y, and z components
     * 
     * @param vector The float array containing the x, y, and z components
     */
    ...
    public Vector3 cross(Vector3 other) {
        float result_x = (this.y * other.z) - (this.z * other.y);
        float result_y = (this.z * other.x) - (this.x * other.z);
        float result_z = (this.x * other.y) - (this.y * other.x);
    ...
    public Vector3 rotate(Rotation3 rotation) {
        float[][] rotationMatrix = rotation.rotationMatrix;
        float r_x = x * rotationMatrix[0][0] + y * rotationMatrix[1][0] + z * rotationMatrix[2][0];
        float r_y = x * rotationMatrix[0][1] + y * rotationMatrix[1][1] + z * rotationMatrix[2][1];
        float r_z = x * rotationMatrix[0][2] + y * rotationMatrix[1][2] + z * rotationMatrix[2][2];
     ...
     * @return True if the vectors are equals given the allowable error, false if
     *         not
     */
     ...
     *         not
     */
    public boolean equals(Vector3 other, float allowableError) {
