...
public class ChassisSpeeds {
     ...
     */
    public float vxMetersPerSecond;

    /**
     * Represents sideways velocity w.r.t the robot frame of reference. (Left is +)
     */
    public float vyMetersPerSecond;

    /**
     * Represents the angular velocity of the robot frame. (CCW is +)
     */
    public float omegaRadiansPerSecond;
     ...
     */
    public ChassisSpeeds(float vxMetersPerSecond, float vyMetersPerSecond, float omegaRadiansPerSecond) {
     ...
     *                              relative to the field. Positive x is away from
     *                              your alliance wall.
     * @param vyMetersPerSecond     The component of speed in the y direction
     *                              relative to the field. Positive y is to your
     *                              left when standing behind the alliance wall.
     * @param omegaRadiansPerSecond The angular rate of the robot.
     * @param robotAngle            The angle of the robot as measured by a
     *                              gyroscope. The robot's angle is considered to be
     *                              zero when it is facing directly away from your
     *                              alliance station wall. Remember that this should
     *                              be CCW positive.
     * @return ChassisSpeeds object representing the speeds in the robot's frame of
     *         reference.
     */
    public static ChassisSpeeds fromFieldRelativeSpeeds(float vxMetersPerSecond, float vyMetersPerSecond,
            float omegaRadiansPerSecond, Rotation2d robotAngle) {
    ...
    public String toString() {
        return String.format("ChassisSpeeds(Vx: %.2f m/s, Vy: %.2f m/s, Omega: %.2f rad/s)", vxMetersPerSecond,
