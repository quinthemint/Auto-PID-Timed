...
public class Rotation2d {
     ...
     */
    public Rotation2d(float value) {
        m_value = value;
        m_cos = (float) Math.cos(value);
        m_sin = (float) Math.sin(value);
    }
    ...
    public Rotation2d(float x, float y) {
        ...
        m_value = (float) Math.atan2(m_sin, m_cos);
    }
     ...
     */
    public static Rotation2d fromDegrees(float degrees) {
        return new Rotation2d((float) Math.toRadians(degrees));
    }
     ...
     *
     * <p>
     * The matrix multiplication is as follows: [cos_new] [other.cos,
     * -other.sin][cos] [sin_new] = [other.sin, other.cos][sin] value_new =
    ...
    public float getDegrees() {
        return (float) Math.toDegrees(m_value);
    }
