...
public class Translation2d {
     ...
     */
    public float getDistance(Translation2d other) {
        return (float) Math.hypot(other.m_x - m_x, other.m_y - m_y);
    }
    ...
    public float getNorm() {
        return (float) Math.hypot(m_x, m_y);
    }
     ...
     */
    public Translation2d times(float scalar) {
     ...
     */
    public Translation2d div(float scalar) {
        return new Translation2d(m_x / scalar, m_y / scalar);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Translation2d) {
            return Math.abs(((Translation2d) obj).m_x - m_x) < 1E-9 && Math.abs(((Translation2d) obj).m_y - m_y) < 1E-9;
        }
        return false;
    }
