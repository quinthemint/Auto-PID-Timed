 ...
 * either subclass it or use {@link Command#withTimeout(float)} or
 * {@link Command#withInterrupt(BooleanSupplier)} to give it one. If you only
 * wish to execute a Runnable once, use {@link InstantCommand}.
 */
public class RunCommand extends CommandBase {
    ...
    public RunCommand(Runnable toRun, Subsystem... requirements) {
        m_toRun = ErrorMessages.requireNonNullParam(toRun, "toRun", "RunCommand");
