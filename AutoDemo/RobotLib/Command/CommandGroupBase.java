...
/**
 * A base for CommandGroups. Statically tracks commands that have been allocated
 * to groups to ensure those commands are not also used independently, which can
 * result in inconsistent command state and unpredictable execution.
 */
public abstract class CommandGroupBase extends CommandBase {
    ...
    /**
     * Factory method for {@link SequentialCommandGroup}, included for
     * brevity/convenience.
     *
    ...
    /**
     * Factory method for {@link ParallelCommandGroup}, included for
     * brevity/convenience.
     *
     * @param commands the commands to include
     * @return the command group
    ...
    /**
     * Factory method for {@link ParallelRaceGroup}, included for
     * brevity/convenience.
     *
     * @param commands the commands to include
     * @return the command group
    ...
    /**
     * Factory method for {@link ParallelDeadlineGroup}, included for
     * brevity/convenience.
     *
