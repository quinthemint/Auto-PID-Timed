...
public class ParallelCommandGroup extends CommandGroupBase {
     ...
     * simultaneously. The command group will finish when the last command finishes.
     * If the CommandGroup is interrupted, only the commands that are still running
     * will be interrupted.
     *
