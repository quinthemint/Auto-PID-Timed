...
public class FunctionalCommand extends CommandBase {
     ...
     */
    public FunctionalCommand(Runnable onInit, Runnable onExecute, Consumer<Boolean> onEnd, BooleanSupplier isFinished,
            Subsystem... requirements) {
        m_onInit = ErrorMessages.requireNonNullParam(onInit, "onInit", "FunctionalCommand");
        m_onExecute = ErrorMessages.requireNonNullParam(onExecute, "onExecute", "FunctionalCommand");
        m_onEnd = ErrorMessages.requireNonNullParam(onEnd, "onEnd", "FunctionalCommand");
        m_isFinished = ErrorMessages.requireNonNullParam(isFinished, "isFinished", "FunctionalCommand");
