 ...
 * this is undesired, consider using {@link ScheduleCommand}.
 *
 * <p>
...
public class SelectCommand extends CommandBase {
    ...
    public SelectCommand(Map<Object, Command> commands, Supplier<Object> selector) {
        ...
        m_commands = ErrorMessages.requireNonNullParam(commands, "commands", "SelectCommand");
        m_selector = ErrorMessages.requireNonNullParam(selector, "selector", "SelectCommand");
    ...
    public SelectCommand(Supplier<Command> toRun) {
        m_commands = null;
        m_selector = null;
        m_toRun = ErrorMessages.requireNonNullParam(toRun, "toRun", "SelectCommand");
    }
