...
public class ParallelDeadlineGroup extends CommandGroupBase {
     ...
     * deadline) will be executed simultaneously. The CommandGroup will finish when
     * the deadline finishes, interrupting all other still-running commands. If the
     * CommandGroup is interrupted, only the commands still running will be
     * interrupted.
     *
