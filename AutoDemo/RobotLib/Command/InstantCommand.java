...
public class InstantCommand extends CommandBase {
    ...
    public InstantCommand(Runnable toRun, Subsystem... requirements) {
        m_toRun = ErrorMessages.requireNonNullParam(toRun, "toRun", "InstantCommand");

        addRequirements(requirements);
    }

    /**
     * Creates a new InstantCommand with a Runnable that does nothing. Useful only
     * as a no-arg constructor to call implicitly from subclass constructors.
     */
